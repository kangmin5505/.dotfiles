...
-- Switch to English IME when leaving Insert mode (fcitx5)
vim.api.nvim_create_autocmd("InsertLeave", {
	desc = "Switch to English input when leaving insert mode",
	group = vim.api.nvim_create_augroup("korean-ime", { clear = true }),
	callback = function()
